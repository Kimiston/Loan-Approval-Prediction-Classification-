...
# installed.
TCL_PREFIX='E:/MLProject/MLClass\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/MLProject/MLClass\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/MLProject/MLClass\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/MLProject/MLClass\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/MLProject/MLClass\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/MLProject/MLClass\Library\lib\tclstub86.lib'
